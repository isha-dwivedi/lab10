...
class Rectangle{
	point p1, p2, p3, p4;
	int a,b;
	//private member functions to calculate sides
	int side1(int a)
	{//this->a=a; 
	a=p3.getx()-p1.getx();
	return a; }
	...
	//point objects treated as variables
	public:
	...
	int area()//member function using private side function to claculate area
	{ cout<<"area="<<side1(a)*side2(b);}
